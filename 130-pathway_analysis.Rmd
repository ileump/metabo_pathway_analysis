...
file.data <- '/Users/leump/Desktop/data.csv'
file.sample <- '/Users/leump/Desktop/sample.csv'
file.var <- '/Users/leump/Desktop/var.csv'

## test type
test <- c('Dunn', 'Games-Howell', 'T', 'Mann-Whitney-U',"Wilcox")[3]
test.paired <- FALSE
